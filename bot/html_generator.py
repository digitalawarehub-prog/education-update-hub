...
def detect_content_language(job):
    ...
    if counts.get(best,0)>=2: return best
    if len(re.findall(r"[A-Za-z]",text))>=20: return "en"
    return "hi"
